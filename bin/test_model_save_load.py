...
def main_test_save_load():
    ...
    input_names = [name for cfg in model_configs for name in cfg['args']['input_names']] + ['not_in_input']
    output_names = [name for cfg in model_configs for name in cfg['args']['output_names']] + ['not_in_output']
